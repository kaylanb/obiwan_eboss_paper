...
\begin{figure}
 ...
 \caption{PDFs of \gb, \rband, \zb, redshift, and $\rhalf$ for 10,000 draws using the algorithm in Section \ref{sec:final-eboss-sample}. \obiwan\, will inject galaxies having these properties into the same set of DECam CCDs that produced the DR3-era \tractor\, catalogues and eBOSS ELG target lists.}
