...
\item We applied to this method to the eBOSS ELG sample using the \obiwan\, code (Burleigh et al. prepa). The resulting angular correlation function reproduces the CFHT-BOSS-DEEP2 correlation function \citep{corrfuncJohan} for $\theta < 1$ deg, and extends the correlation function to $\theta < 5$ deg.
