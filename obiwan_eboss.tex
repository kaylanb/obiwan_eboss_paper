...
INSERT JUST THE rhalf INPUT PLOT HERE. IF TIME COMBINE INTO 6 PANELS WITH GRZ MAG DIST, PA,BA, e1,e2, AND RHALF INPUT. IN THAT CASE COULD DROP THE BA,PA BOX AND JUST SAW THIS IS e1,e2, DIST FOR UNIFORM BA,PA. THE NUMBER EXP, DEV BARPLOT CAN STAY BUT AS 6th PANEL COULD PUT IN BAR PLOT SHOWING PERCENTAGE INPUT OF EACH TYPE ON X-AXIS FOR SIMPLICITY
