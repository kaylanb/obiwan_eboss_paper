...
The two most popular map-based methods are template subtraction (aka regression or best-fit simple models) and model projection \citep{biasInTemplateMethod}. Template subtraction predicts the per-pixel galaxy counts from the feature vector of imaging meta-data and foregrounds in that pixel \citep{sdss1Systematics, myers06, sdss8Systematics, sdss8Companion, sdss9Systematics, sdss12Systematics, wigglezSelectionFunc, delubacSystematics, qsoDepthExtinction, prakashRegressionTech, myersRegressionTech, elvinpoole}. Model projection does X \citep{uros04, biasInTemplateMethod, leistedt13}. \red{read biasInTemplateMethod paper for how works}
