...
\subsection{Recovered ELGs, Lost ELGs, and Contaminants}
...
Future studies that want to use \obiwan\, randoms for computing correlation functions can use the following maps to up- and down-weight their randoms.
